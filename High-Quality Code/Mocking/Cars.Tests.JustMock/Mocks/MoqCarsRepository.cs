namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class MoqCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            // homework
            mockedCarsRepository.Setup(r => r.Search(It.Is<string>(param => param == "BMV")))
                .Returns(this.FakeCarCollection.Where(c => c.Make.ToLower() == "BMV".ToLower() || c.Model.ToLower() == "BMV".ToLower()).ToList());
            mockedCarsRepository.Setup(r => r.Search(It.Is<string>(param => string.IsNullOrEmpty(param)))).Returns(this.FakeCarCollection.ToList());
            ...
            mockedCarsRepository.Setup(r => r.Add(It.Is<Car>(param => param.Year < 1900 || param.Year > (DateTime.Now.Year)))).Throws(new ArgumentOutOfRangeException());
